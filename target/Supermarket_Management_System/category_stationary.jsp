    ...
    <main class="main-content">
        ...
        <div class="product-grid">
            <div class="product-card">
                <img src="https://images.unsplash.com/photo-1531346680769-a1d79b57de5c?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=500&q=80" alt="Premium Notebook" class="product-image">
                <div class="product-info">
                    <h3>Premium Notebook</h3>
                    <p>High-quality paper with durable cover</p>
                    <div class="price">$12.99</div>
                    <div class="product-actions">
                        <button class="add-to-cart-btn" onclick="showNotification(3, 'Premium Notebook', 12.99, 'https://images.unsplash.com/photo-1531346680769-a1d79b57de5c?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=500&q=80')">Add To Cart</button>
            ...
            <div class="product-card">
                ...
                <div class="product-info">
                    ...
                    <div class="product-actions">
                        <button class="add-to-cart-btn" onclick="showNotification(4, 'Gel Pen Set', 4.99, 'https://imgs.search.brave.com/JGaObmib5LQEPd5rGhXn-Zm4tLh-Sju7lEzifd09sDw/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly9tLm1l/ZGlhLWFtYXpvbi5j/b20vaW1hZ2VzL0kv/ODFySm5KMk1Fbkwu/anBn')">Add To Cart</button>
            ...
            <div class="product-card">
                ...
                <div class="product-info">
                    ...
                    <div class="price">$12.99</div>
                    <div class="product-actions">
                        <button class="add-to-cart-btn" onclick="showNotification(5, 'Heavy Duty Stapler', 12.99, 'https://imgs.search.brave.com/eYMVDHVLTE1otkMhpCqzE2S_OJj1XecJ5LuD_R5J2wo/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly9tLm1l/ZGlhLWFtYXpvbi5j/b20vaW1hZ2VzL0kv/NzFyemdCOWdJWEwu/anBn')">Add To Cart</button>
            ...
            <div class="product-card">
                ...
                <div class="product-info">
                    ...
                    <div class="product-actions">
                        <button class="add-to-cart-btn" onclick="showNotification(6, 'A4 Paper Ream', 6.99, 'https://imgs.search.brave.com/HHiFrKbwWB9ye0fzswdYCrqATZePowZUaI0hZPC95UY/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly9pbWFn/ZS5tYWRlLWluLWNo/aW5hLmNvbS8xNTVm/MGowMHNvR2JPdWZx/blNrZy9BNC1QYXBl/ci1Db3BpZXItNTAw/LVNoZWV0cy1SZWFt/LTUtUmVhbXMtQm94/LUE0LUNvcHktUGFw/ZXIud2VicA')">Add To Cart</button>
            ...
            <div class="product-card">
                ...
                <div class="product-info">
                    ...
                    <div class="product-actions">
                        <button class="add-to-cart-btn" onclick="showNotification(7, 'Drawing Pencil Set', 14.99, 'https://imgs.search.brave.com/r5sZRGU6LkFkf8-Ev5TgEisGu36un294vc7s7whUSTY/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly93d3cu/YW5uYWJyZWdtYW5w/b3J0cmFpdHMuY28u/dWsvd3AtY29udGVu/dC91cGxvYWRzLzIw/MTQvMDgvQVJUSUNM/RVMtcGVuY2lsLXJl/dmlld3MtRmFiZXIt/Q2FzdGVsbDMuanBn')">Add To Cart</button>
            ...
            <div class="product-card">
                ...
                <div class="product-info">
                    ...
                    <div class="product-actions">
                        <button class="add-to-cart-btn" onclick="showNotification(8, 'Whiteboard Markers', 8.99, 'https://imgs.search.brave.com/C__9T5MZx9UQbHZcrBcz2I_XF76nwdv-JB_WdyklNe0/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly9zaG9w/LmdoZW50LmNvbS93/cC1jb250ZW50L3Vw/bG9hZHMvMjAyNC8w/My9naGVudC1lcmFz/ZXItbWFya2VyLWNv/bWJvLWFuZ2xlLXZh/cmlldHktMTUwMHgx/NTAwLTEuanBn')">Add To Cart</button>
