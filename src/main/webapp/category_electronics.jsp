        ...
        <div class="product-grid">
            <div class="product-card">
                ...
                <div class="product-info">
                    ...
                    <div class="product-actions">
                        <button class="add-to-cart-btn" onclick="showNotification('Premium Laptop', 899.99)">Add To Cart</button>
            ...
            <div class="product-card">
                ...
                <div class="product-info">
                    ...
                    <div class="product-actions">
                        <button class="add-to-cart-btn" onclick="showNotification('Smart Phone', 699.99)">Add To Cart</button>
            ...
            <div class="product-card">
                ...
                <div class="product-info">
                    ...
                    <div class="product-actions">
                        <button class="add-to-cart-btn" onclick="showNotification('4K Smart TV', 549.99)">Add To Cart</button>
            ...
            <div class="product-card">
                ...
                <div class="product-info">
                    ...
                    <div class="product-actions">
                        <button class="add-to-cart-btn" onclick="showNotification('Wireless Headphones', 199.99)">Add To Cart</button>
            ...
            <div class="product-card">
                ...
                <div class="product-info">
                    ...
                    <div class="product-actions">
                        <button class="add-to-cart-btn" onclick="showNotification('Smart Microwave', 149.99)">Add To Cart</button>
            ...
            <div class="product-card">
                ...
                <div class="product-info">
                    ...
                    <div class="product-actions">
                        <button class="add-to-cart-btn" onclick="showNotification('Fitness Smartwatch', 129.99)">Add To Cart</button>
