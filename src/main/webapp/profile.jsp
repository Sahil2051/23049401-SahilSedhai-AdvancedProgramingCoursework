                    ...
                    <div id="overview">
                        <div class="profile-header">
                            ...
                            <div class="profile-info">
                                <h2>Sohail Khan</h2>
                                <p>Sohailsiddique00001@gmail.com</p>
                            </div>
                        </div>
                    ...
                    <div id="edit" style="display: none;">
                        ...
                        <form>
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" value="Sohail Khan">
                            </div>
                            <div class="form-group">
                                <label>Email</label>
                                <input type="email" class="form-control" value="sohailsiddique00001@gmail.com">
                            </div>
                            <div class="form-group">
                                <label>Phone</label>
                                <input type="tel" class="form-control" value="9807346865">
                            </div>
                            <div class="form-group">
                                <label>Address</label>
                                <textarea class="form-control" rows="3">Dharan, Shantipath, Nepal.</textarea>
                            </div>
                            <div class="btn-group">
