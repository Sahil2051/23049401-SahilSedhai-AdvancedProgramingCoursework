        ...
        <div class="product-grid">
            <div class="product-card">
                ...
                <div class="product-info">
                    ...
                    <div class="product-actions">
                        <button class="add-to-cart-btn" onclick="showNotification('Premium Vacuum Cleaner', 199.99)">Add To Cart</button>
            ...
            <div class="product-card">
                ...
                <div class="product-info">
                    ...
                    <div class="product-actions">
                        <button class="add-to-cart-btn" onclick="showNotification('Smart Vacuum Robot', 299.99)">Add To Cart</button>
            ...
            <div class="product-card">
                ...
                <div class="product-info">
                    ...
                    <div class="product-actions">
                        <button class="add-to-cart-btn" onclick="showNotification('Compact Vacuum', 149.99)">Add To Cart</button>
            ...
            <div class="product-card">
                ...
                <div class="product-info">
                    ...
                    <div class="product-actions">
                        <button class="add-to-cart-btn" onclick="showNotification('Professional Vacuum', 399.99)">Add To Cart</button>
            ...
            <div class="product-card">
                ...
                <div class="product-info">
                    ...
                    <div class="product-actions">
                        <button class="add-to-cart-btn" onclick="showNotification('Handheld Vacuum', 79.99)">Add To Cart</button>
            ...
            <div class="product-card">
                ...
                <div class="product-info">
                    ...
                    <div class="product-actions">
                        <button class="add-to-cart-btn" onclick="showNotification('Wet/Dry Vacuum', 249.99)">Add To Cart</button>
            ...
            <div class="product-card">
                ...
                <div class="product-info">
                    ...
                    <div class="product-actions">
                        <button class="add-to-cart-btn" onclick="showNotification('Car Vacuum Cleaner', 89.99)">Add To Cart</button>
            ...
            <div class="product-card">
                ...
                <div class="product-info">
                    ...
                    <div class="product-actions">
                        <button class="add-to-cart-btn" onclick="showNotification('Steam Vacuum', 329.99)">Add To Cart</button>
